...
{
    [Entity(TableCnName = "派工单管理",TableName = "WOC_WorkOrderdispatch",DetailTable =  new Type[] { typeof(WOC_WorkOrderdispatchChild)},DetailTableCnName = "WOC_WorkOrderdispatchChild",DBServer = "SysDbContext")]
    public partial class WOC_WorkOrderdispatch:SysEntity
    {
        /// <summary>
       ///主工单号
       /// </summary>
       ...
       [Display(Name ="WOC_WorkOrderdispatchChild")]
       [ForeignKey("MWOId")]
       public List<WOC_WorkOrderdispatchChild> WOC_WorkOrderdispatchChild { get; set; }
