...
{
    [Entity(TableCnName = "检验工具类型",TableName = "QCM_SIPToolTypeFile",DBServer = "SysDbContext")]
    public partial class QCM_SIPToolTypeFile:SysEntity
    {
        /// <summary>
       ///
       /// </summary>
       [Display(Name ="SIPToolTypeId")]
       [Column(TypeName="uniqueidentifier")]
       [Editable(true)]
       public Guid? SIPToolTypeId { get; set; }
