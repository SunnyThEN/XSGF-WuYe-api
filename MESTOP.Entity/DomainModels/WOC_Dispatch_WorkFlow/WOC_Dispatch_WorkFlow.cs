...
{
    [Entity(TableCnName = "已派工序",TableName = "WOC_Dispatch_WorkFlow",DetailTableCnName = " ",DBServer = "ServiceDbContext")]
    public partial class WOC_Dispatch_WorkFlow:ServiceEntity
    {
        /// <summary>
       ///工序名称
       /// </summary>
