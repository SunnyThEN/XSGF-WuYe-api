...
{
    [Entity(TableCnName = "自检检验",TableName = "QCM_ProcessCheck",DetailTable =  new Type[] { typeof(QCM_ProcessCheckTestItem)},DetailTableCnName = "自检检验项",DBServer = "ServiceDbContext")]
    public partial class QCM_ProcessCheck:ServiceEntity
    {
        /// <summary>
       ///检验类型
       /// </summary>
       ...
       public List<QCM_ProcessCheckTestItem> QCM_ProcessCheckTestItem { get; set; }
