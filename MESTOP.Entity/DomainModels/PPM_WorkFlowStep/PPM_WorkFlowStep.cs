...
{
    [Entity(TableCnName = "工序节点配置",TableName = "PPM_WorkFlowStep",DBServer = "SysDbContext")]
    public partial class PPM_WorkFlowStep:SysEntity
    {
        /// <summary>
       ///工序流程顺序
       /// </summary>
       ...
       ///自动下推质检单时间
       /// </summary>
       [Display(Name ="自动下推质检单时间")]
       [Column(TypeName="int")]
       [Editable(true)]
       public int? TriggleType { get; set; }
