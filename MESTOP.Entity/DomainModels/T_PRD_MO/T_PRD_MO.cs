...
{
    [Entity(TableCnName = "ERP工单主表",TableName = "T_PRD_MO",DBServer = "TestDbContext")]
    public partial class T_PRD_MO:TestEntity
    {
        /// <summary>
       ///
       /// </summary>
