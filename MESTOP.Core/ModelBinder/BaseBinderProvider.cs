...
namespace MESTOP.Core.ModelBinder
{
    public class BaseBinderProvider : IModelBinderProvider
    {
     ...
     //   public List<BinderObject> binder=new BinderObject()
        ...
        private void InitType()
        {
            ...
            AddType(typeof(List<MESTOP.Entity.DomainModels.Sys_TableColumn>));
            AddType(typeof(MESTOP.Entity.DomainModels.Sys_TableInfo));
        }
        /// <summary>
