...
using gridreport;
using MESTOP.Core.Report.PInvokeWindows;
using BinaryObject = MESTOP.Core.Report.PInvokeWindows.BinaryObject;
using E2IMGOption = MESTOP.Core.Report.PInvokeWindows.E2IMGOption;

namespace MESTOP.Core.common
{
