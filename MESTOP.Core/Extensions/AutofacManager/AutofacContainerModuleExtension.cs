...
using MESTOP.Core.CacheManager;
using MESTOP.Core.Configuration;
using MESTOP.Core.Const;
using MESTOP.Core.Dapper;
...
namespace MESTOP.Core.Extensions
{
    public static class AutofacContainerModuleExtension
    {
        ...
        public static IServiceCollection AddModule(this IServiceCollection services, ContainerBuilder builder, IConfiguration configuration)
        {
            ...
            try
            {
                ...
                string rootPath = (webHostEnvironment.ContentRootPath + "\\packages").ReplacePath();
