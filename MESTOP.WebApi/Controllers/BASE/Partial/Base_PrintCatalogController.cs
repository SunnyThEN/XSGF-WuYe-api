...
using MESTOP.Core.Print.Umisky.BarcodePrint.Core;
...
namespace BASE.Controllers
{
    public partial class Base_PrintCatalogController
    {
        ...
        [ApiActionPermission]
        [AllowAnonymous]
        [HttpPost, Route("Prints")]
        public string Prints()
        {
            PrintHelpter prints = new PrintHelpter();
            var bb = PrintHelpter.GetDefaultPrinter();
            prints.print(bb, "test printer!");
            return "1111";
        }
    }
}
